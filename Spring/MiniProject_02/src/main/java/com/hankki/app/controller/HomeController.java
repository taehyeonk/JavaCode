...
public class HomeController {
	...
	@RequestMapping(value = "/detail/updateform", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/detail/deleteform", method = RequestMethod.GET)
