...
public class LogAspect {
	...
	public void beforeLog(JoinPoint joinPoint) {
		...
		System.out.println("[Log: Before] 硫붿꽌�뱶 �씠由� : " + signature.getName());
	}

	@After("helloPointcut()")
	public void afterLog(JoinPoint joinPoint) {
		Signature signature = joinPoint.getSignature();
		System.out.println("[Log: After] 硫붿꽌�뱶 �씠由� : " + signature.getName());
	}

	@AfterReturning(pointcut="helloPointcut()", returning="message")
	public void afterReturningLog(JoinPoint joinPoint, String message) {
		Signature signature = joinPoint.getSignature();
		System.out.println("[Log: AfterReturning] 硫붿꽌�뱶 �씠由� : " + signature.getName());
		System.out.println("[Log: AfterReturning] 硫붿꽌�뱶 由ы꽩 媛� : " + message);
	}
	...
	public void afterThrowingLog(JoinPoint joinPoint, Exception exception) {
		Signature signature = joinPoint.getSignature();
		System.out.println("[Log: AfterThrowing] 硫붿꽌�뱶 �씠由� : " + signature.getName());
		System.out.println("[Log: AfterThrowing] �삁�쇅 諛쒖깮 : " + exception.getMessage());
	}
	...
	public Object trace(ProceedingJoinPoint joinPoint) throws Throwable{
		...
		Object result = null;
		try{
			result = joinPoint.proceed(); // sayHello() 실행되는 곳
		}catch(Exception e){
