...
<body>
	<form id="form" action="/hankki/${store.storeId}/update" method="post">
			...
			<table border="0">
				<tr>
					<td>
						...
						<div class="card">
							<input type="text" name="imgStr" value="${store.imgStr}">
							<div class="card-body" style="background-color: #F8ECE0">
								...
								<p class="card-text" align="center">
									<input type="text" name="position" value="${store.position}">
								</p>
						...
						<c:forEach var="menu" items="${menu}" varStatus="status">
							<tr>
								...
								<td>
									<div class="row">
										<div class="col text-center">
											<%-- <a href="<c:url value='./menu_deleteform'/>">
