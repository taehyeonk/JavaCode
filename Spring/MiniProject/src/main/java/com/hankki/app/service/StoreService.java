...
public class StoreService implements IStoreService {
	...
	@Override
	public List<ListVO> getStoreStarAvg() {
		return storeRepository.getStaravg();
	}
	
	@Override
	public ListVO getStoreStarAvg(int storeid) {
		return storeRepository.getStarinfo(storeid);
	}

	@Override
	public int getStoreMenuCount(int storeId) { 
		return storeRepository.getStoreMenuCount(storeId);
	}
